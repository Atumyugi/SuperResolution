...
def get_args():
    ...
    parser.add_argument("--savepath", type=str, default='./checkpoint/flip_image/my_flip_image.pkl', help="save model path")
    ...
    #Test
    parser.add_argument("--test_type", type=str, default='C', help=
                                                        "A: 超分辨率 并且把图片都保存 txt也有"
                                                        "B: 超分辨率 只看总PSNR 指标"
                                                        "C: 超分辨率 没有高清视频对比,只有低清视频 处理完生成SR图片")
